...
export function countryWithEmoji(c: Country) {
  return `${c.emoji} ${c.name}`
}

export const mostImportantCountriesListInPortuguese: Country[] =
  [
    //--------------------------------------------------------
...
export const countriesListInEnglish: Country[] = [
  {
    code: "AD",
    name: "Andorra",
    native: "Andorra",
